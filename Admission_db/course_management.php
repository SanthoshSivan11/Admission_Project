...
.update{
    padding:5px;
    background-color:rgb(252, 220, 64);
    transition: background-color 0.3s ease, transform 0.2s ease;
    border-radius:5px ;

}
.update:hover{
  background-color:rgb(222, 179, 9);
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="delete" href="course_management.php?delete=<?= $course['id']; ?>" onclick="return confirm('Are you sure you want to delete this course?');">Delete</a>
                    </td>
                </tr>
